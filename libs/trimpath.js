...
(function(){
	...
	TrimPath.parseTemplate_etc.modifierDef = {
		...
		"money"		: function(c)	{ if(isNaN(c)) return 'NaN';c=(''+Math.round(c*100)/100).match(/(\d*)\.?(\d*)/); while(c[2].length<2){c[2]+=0} return c[1]+'.'+c[2]},
		"integer"	: function(c)	{ if(isNaN(c)) return 'NaN';return parseInt(c) },
		"fractional": function(c)	{ if(isNaN(c)) return 'NaN';var a=(''+c).match(/\.(\d*)$/); return a&&a[1]?a[1]:"00" },
